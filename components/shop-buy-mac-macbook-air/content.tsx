...
interface BuyMacBookAirContentProps {
  dictionary: Dictionary
  lang: Locale
}

const sizes = [
  { name: '13"', description: "Ultra-portable" },
  { name: '15"', description: "More room to create" },
]

const chips = [
  { name: "M3", price: "From $999", description: "8-core CPU, 8-core GPU" },
  { name: "M4", price: "From $1,099", description: "10-core CPU, 10-core GPU" },
]
...
export function BuyMacBookAirContent({ dictionary, lang }: BuyMacBookAirContentProps) {
      ...
      <section className="py-8 bg-white">
        <div className="apple-container flex justify-center">
          <div className="relative w-full max-w-2xl h-[400px]">
            <Image
              src="https://www.apple.com/v/macbook-air/s/images/overview/hero/hero_mba_m4__epzwl9g96gia_xlarge_2x.jpg"
              alt="MacBook Air"
              fill
      ...
      <section className="py-16 bg-white">
        <div className="apple-container text-center">
          <h2 className="text-3xl font-semibold text-[#1d1d1f] mb-12">
            What makes MacBook Air so capable.
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="text-4xl mb-4">🪶</div>
              <h3 className="font-semibold text-[#1d1d1f] mb-2">Incredibly Thin</h3>
              <p className="text-sm text-[#6e6e73]">Just 11.3mm thin and under 3 lbs.</p>
            </div>
            <div>
              <div className="text-4xl mb-4">⚡</div>
              <h3 className="font-semibold text-[#1d1d1f] mb-2">Apple Silicon</h3>
              <p className="text-sm text-[#6e6e73]">M3 or M4 chip for incredible performance.</p>
            </div>
            <div>
              <div className="text-4xl mb-4">🔋</div>
              <h3 className="font-semibold text-[#1d1d1f] mb-2">Up to 18 Hours</h3>
              <p className="text-sm text-[#6e6e73]">All-day battery life.</p>
            </div>
            <div>
              <div className="text-4xl mb-4">🔇</div>
              <h3 className="font-semibold text-[#1d1d1f] mb-2">Fanless Design</h3>
              <p className="text-sm text-[#6e6e73]">Completely silent.</p>
            </div>
          </div>
        </div>
      </section>

...
interface BuyIPhone16ProContentProps {
...
export function BuyIPhone16ProContent({ dictionary, lang }: BuyIPhone16ProContentProps) {
      ...
      <section className="py-8 bg-white">
        <div className="apple-container flex justify-center">
          <div className="relative w-full max-w-lg h-[500px]">
            <Image
              src="https://www.apple.com/v/iphone-16-pro/d/images/overview/design/design_titanium__cnr7sjjuvhem_xlarge_2x.jpg"
              alt="iPhone 16 Pro"
              fill
